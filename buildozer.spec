...
[app]
#icon van de app
icon.filename = assets/A.png

#bonodigtheden voor vibreren, batterij en ander stuff
android.permissions = android.permission.BATTERY_STATS, POST_NOTIFICATIONS, android.permission.VIBRATE, android.permission.INTERNET, android.permission.READ_EXTERNAL_STORAGE

version = 2.21

# begin scherm
#presplash.filename = assets/A.png
...
source.include_exts = py,png,jpg,kv,atlas,assets,Files
...
requirements = python3,plyer,gtts,kivy,kivymd,discord-webhook,openssl,pillow,numpy,mapview,kivy-garden.mapview,requests
...
#presplash.filename = %(source.dir)s/jsondata/presplash.png

# (str) Icon of the application
#icon.filename = %(source.dir)s/jsondata/icon.png
...
#icon.adaptive_foreground.filename = %(source.dir)s/jsondata/icon_fg.png
#icon.adaptive_background.filename = %(source.dir)s/jsondata/icon_bg.png
...
#android.ouya.icon.filename = %(source.dir)s/jsondata/ouya_icon.png
...
# (list) Android application meta-jsondata to set (key=value format)
#android.meta_data =
